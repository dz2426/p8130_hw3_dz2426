...
Table 3: Total activity measured in minutes for the 63 year-old male with BMI 25 on each day over 5 weeks
```{r echo = FALSE}
...
ggplot(accel_time_course, aes(x = time_of_day_hr, y = activity_count)) +
  ...
  ggtitle("Figure 4a: Physical activity of the 63 year-old male with BMI 25 over 5 weeks") +
  theme(title = element_text(size = 13),
        axis.title = element_text(size = 14),
